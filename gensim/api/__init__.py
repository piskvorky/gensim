...
def link(file_name, shortcut_name):
	...
	if package_is_installed == 0:
		print("The model/corpus {f} has not been installed. Please install it using : python -m gensim -d {f}".format(f=file_name))
	...
	try:
   	...
   	print("Shortcut creation successful. The model/corpus can now be found in gensim/data.")
