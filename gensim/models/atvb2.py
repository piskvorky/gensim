...
class AtVb2(LdaModel):
    ...
    def inference(self, corpus=None, author2doc=None, doc2author=None, var_lambda=None):
        ...
        expElogtheta = numpy.exp(dirichlet_expectation(var_gamma))
                ...
                for v in ids:
                    for a in authors_d:
                        for k in xrange(self.num_topics):
                            ...
                            # NOTE: won't var_phi[d, v, a, k] be the same for two different d if 
                            # a is the same?
                            ...
                            var_phi[d, v, a, k] = expElogtheta[a, k] * expElogbeta[k, v]
                    # Normalize phi.
