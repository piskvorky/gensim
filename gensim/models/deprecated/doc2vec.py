...
def load_old_doc2vec(*args, **kwargs):
    ...
    new_model.docvecs.max_rawint = old_model.docvecs.__dict__.get('max_rawint', None)
    new_model.docvecs.offset2doctag = old_model.docvecs.__dict__.get('offset2doctag', None)
