...
tf.app.flags.DEFINE_integer("task_index", 0, "Index of the task within the job")
...
def distributed_w2v_init(self, options, session):
...
class Distributed_Word2Vec(KeyedVectors):
