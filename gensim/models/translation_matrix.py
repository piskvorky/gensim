...
class TranslationMatrix(utils.SaveLoad):
    ...
    def translate(self, source_words, topn=5, gc=0, sample_num=None, source_lang_vec=None, target_lang_vec=None):
        ...
        gc : int, optional
            ...
            otherwise, use globally corrected neighbour retrieval method (as described in `Improving zero-shot learning
            by mitigating the hubness problem <https://arxiv.org/abs/1412.6568>`).
