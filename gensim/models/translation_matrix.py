...
class BackMappingTranslationMatrix(utils.SaveLoad):
    ...
    def __init__(self, source_lang_vec, target_lang_vec, tagged_docs=None, random_state=None):
        ...
        tagged_docs : list of :class:`~gensim.corpora.taggeddocument.TaggedDocument`, optional.
    ...
    def train(self, tagged_docs):
        ...
        Parameters
        ----------
        tagged_docs : list of :class:`~gensim.corpora.taggeddocument.TaggedDocument`, Documents
