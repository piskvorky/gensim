...
class Wordrank(KeyedVectors):
    ...
    def train(cls, wr_path, corpus_file, out_name, size=100, window=15, symmetric=1, min_count=5, max_vocab_size=0,
        ...
        which is created inside wordrank directory.
        The vocab and cooccurence files are generated using glove code available inside the wordrank directory.
        These files are used by the wordrank binary for training.
