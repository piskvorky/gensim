...
Example Usage:
$ python mp_eval.py --wikiqa_folder_path ./data/WikiQACorpus/ --word_embedding_path evaluation_scripts/glove.6B.50d.txt  # noqa
"""
...
if __name__ == '__main__':
    ...
    drmm_tks = MatchPyramid(embedding=wikiqa_train.embedding_matrix, vocab_size=wikiqa_train.embedding_matrix.shape[0],
    ...
    model.fit(x={"query": X1_train, "doc": X2_train, "dpool_index": 1}, y=y_train, batch_size=64, verbose=1, epochs=10)
    ...
    predictions = model.predict(x={"query": X1, "doc": X1, "dpool_index": 1})
    ...
    print("nDCG :", mean_ndcg(Y_true, Y_predicted))
