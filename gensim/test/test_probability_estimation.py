...
class TestProbabilityEstimation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.segmented_topics = [[(5798, 18451), (10608, 18451), (10608, 5798)], [
    ...
    def testPBooleanDocument(self):
        ...
        obtained, _ = probability_estimation.p_boolean_document(
            self.corpus, self.segmented_topics)
        expected = {18451: set([5]), 12736: set(
            [1, 3]), 5798: set([1, 2]), 10608: set([0])}
    ...
    def testPBooleanSlidingWindow(self):
        ...
        expected = {10608: set([1]), 12736: set(
            [8, 2, 3]), 18451: set([11]), 5798: set([4, 5, 6, 7])}
        self.assertTrue(obtained == expected)
