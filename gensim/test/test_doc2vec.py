...
class TestDoc2VecModel(unittest.TestCase):
    ...
    def test_int_doctags(self):
        ...
        self.assertEqual(len(model.docvecs.doctag_syn0), 300)  # example count
        self.assertEqual(model.docvecs[0].shape, (100,))  # vector size
    ...
    def test_string_doctags(self):
        ...
        self.assertEqual(len(model.docvecs.doctag_syn0), 300)  # example count
        self.assertEqual(model.docvecs[0].shape, (100,))  # vector size
        self.assertEqual(model.docvecs['_*0'].shape, (100,))  # vector size
