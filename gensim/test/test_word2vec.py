...
from gensim.test.utils import LeeCorpus
from gensim.test.utils import common_texts as sentences
from gensim.test.utils import datapath, get_tmpfile, lee_corpus_list, temporary_file
...
class TestWord2VecModel(unittest.TestCase):
    ...
    def test_evaluate_word_pairs(self):
        ...
        self.assertTrue(
            0.1 < spearman < 1.0, "spearman {spearman} not between 0.1 and 1.0"
        )
