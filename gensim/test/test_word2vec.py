...
class TestWord2VecModel(unittest.TestCase):
    ...
    def testTrainAsymmetric(self):
        ...
        asym_model = word2vec.Word2Vec(size=10, min_count=1, sg=0, hs=0, negative=5, symmetric=0, window=2)
        ...
        sym_model = word2vec.Word2Vec(size=10, min_count=1, sg=0, hs=0, negative=5, symmetric=1, window=2, iter=100,
