...
class TestKeywordsTest(unittest.TestCase):
    ...
    def test_text_keywords_pos(self):
        ...
        generated_keywords_NNVBJJ = keywords(
            text, pos_filter=[
                'NN', 'VB', 'JJ'], ratio=0.3, split=True)
        ...
        self.assertEqual(
            set(map(str, generated_keywords_NNVBJJ)), set(map(str, kw)))
    ...
    def test_keywords_ratio(self):
        ...
        # numerical instabilities when several keywords have almost the same
        # score
