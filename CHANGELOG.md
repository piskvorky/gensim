...
* Passed all the params through the apply call in lda.get_document_topics(), attempt test case to use the get_document_topic function through the corpus in test_ldamodel (@parthoiiitm, [#963](https://github.com/RaRe-Technologies/gensim/pull/963))
