...
* `NumPy <http://www.numpy.org>`_ >= 1.0.4. Tested with version 1.4.0, 1.3.0rc2 and 1.0.4.
* `SciPy <http://www.scipy.org>`_ >= 0.6. Tested with version 0.8.0b1, 0.7.1 and 0.6.0.
