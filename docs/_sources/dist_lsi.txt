...
In serial mode, creating the LSI model of Wikipedia takes about 14h on my laptop (OS X, dual-core 2.53GHz, 4GB RAM with `libVec`). 
In distributed mode with eight workers (Linux, dual-core Xeons of 2Ghz, 4GB RAM with `ATLAS`), the wallclock time taken drops to 2 hours and 23 minutes.
