...
extensions = ['sphinx.ext.autodoc', 'sphinxcontrib.napoleon', 'sphinx.ext.imgmath']  # temporary disable plugin by 'numpy.ufunc has the wrong size' reason., 'sphinxcontrib.programoutput']
