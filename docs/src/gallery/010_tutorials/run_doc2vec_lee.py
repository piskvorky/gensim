...
###############################################################################
# Doc2Vec is a :ref:`core_concepts_model` that represents a
...
#
# However, Le and Mikolov in 2014 introduced the *Paragraph Vector*\ , which usually outperforms such simple-averaging.
#
